...
define('_AM_SYSTEM_BLOCKS_ADDBLOCK', 'Adicionar novo bloco');
...
define('_AM_SYSTEM_BLOCKS_SIDETOPLEFT', 'Superior esquerdo');
define('_AM_SYSTEM_BLOCKS_SIDETOPCENTER', 'Superior centro');
define('_AM_SYSTEM_BLOCKS_SIDETOPRIGHT', 'Superior direito');
...
define('_AM_SYSTEM_BLOCKS_SIDEFOOTERCENTER', 'Rodapé centro');
...
define('_AM_SYSTEM_BLOCKS_CBFOOTERLEFT', 'Bloco rodapé - esquerda');
define('_AM_SYSTEM_BLOCKS_CBFOOTERCENTER', 'Bloco rodapé - centro');
define('_AM_SYSTEM_BLOCKS_CBFOOTERRIGHT', 'Bloco rodapé - direita');
...
define('_AM_SYSTEM_BLOCKS_TOPPAGE', 'Página do topo');
...
define('_AM_SYSTEM_BLOCKS_DRAG', 'Arraste ou ordene o bloco');
define('_AM_SYSTEM_BLOCKS_DBUPDATED', _AM_SYSTEM_DBUPDATED);
define('_AM_SYSTEM_BLOCKS_RUSUREDEL', 'Tem certeza que quer excluir este bloco? <div class="bold">%s</div>');
define('_AM_SYSTEM_BLOCKS_SYSTEMCANT', 'Blocos do sistema não podem ser excluídos!');
define('_AM_SYSTEM_BLOCKS_MODULECANT', 'Este bloco não pode ser excluído diretamente! Para desativá-lo, desative o módulo.');
...
define('_AM_SYSTEM_BLOCKS_FOOTER_CENTER', 'Rodapé centro');
define('_AM_SYSTEM_BLOCKS_FOOTER_RIGHT', 'Rodapé direito');

//2.7.1
//Comment-controls block error (used by modules/system/admin/blocks)
define('_AM_SYSTEM_BLOCKS_INVALID_CLONE', 'Parâmetros de bloco inválidos.');

//2.7.1 backfilled translations
define('_AM_SYSTEM_BLOCKS_CUSTOMHTML', 'Bloco personalizado (HTML)');
define('_AM_SYSTEM_BLOCKS_CUSTOMSMILE', 'Bloco personalizado (formatação automática + emoticons)');
define('_AM_SYSTEM_BLOCKS_AFWSMILE', 'Formatação automática (emoticons ativados)');
define('_AM_SYSTEM_BLOCKS_PHP', 'Script PHP (baseado em ficheiro)');
define('_AM_SYSTEM_BLOCKS_AFNOSMILE', 'Formatação automática (emoticons desativados)');
define('_AM_SYSTEM_BLOCKS_CUSTOMNOSMILE', 'Bloco personalizado (formatação automática)');
