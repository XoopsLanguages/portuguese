...
//2.8.0
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES', 'Ativar administração de idiomas');
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES_DESC', 'Faça a gestão do registo de configurações regionais, pacotes de idioma, verificações de estado e substituições de tradução do site.');
define('_MI_SYSTEM_BNAME14', 'Alternador de idioma');
